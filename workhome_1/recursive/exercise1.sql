...
with recursive cte_recommend as(select fst.recommendedby as recommender,
					   fst.firstname, fst.surname from cd.members fst
					   where fst.memid = 27
					   union all
					   select scd.recommendedby as recommender,
					   scd.firstname, scd.surname from cd.members scd
					   join cte_recommend o on o.recommender = scd.memid)
select o.recommender, scd.firstname, scd.surname from cte_recommend o
