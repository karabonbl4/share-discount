...
=======
    ...
    CONSTRAINT purchase_coupon_fk FOREIGN KEY (coupon_id)
    	REFERENCES public.coupon (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT purchase_discount_card_fk FOREIGN KEY (card_id)
    	REFERENCES public.discount_card (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE
>>>>>>> main
);